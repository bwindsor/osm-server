...
After modifying the style you will need to rebuild and replace the tile server container. This can be done simply by running the [initialise tile server](#initialise-the-tile-server) command above.
